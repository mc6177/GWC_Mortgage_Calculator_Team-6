...
2. Click the link below to find your teams base project.Notice there is already an .xcodeproj setup for you. You will use this to develop your app  [ADD LINK]
...
4. Open up Android Studio. Click the option for “Get from VCS”. 
...
5. Paste your projects HTTPS URL in the URL text box, ensure the project is being cloned in the directory you want, and click clone. When the popup appears, choose “Trust Project”. The Project will automatically open, and you are ready to start coding!
